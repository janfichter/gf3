...
(function() {
    ...
    // ИСПРАВЛЕНО: удалён мёртвый код, вызывавший неопределённую функцию
    // isFamilyTreePage() (что приводило к ReferenceError в консоли браузера)
    // и повторно вызывавший initializeFamilyTree() без аргумента-контейнера.
    // Реальная инициализация уже корректно выполняется выше, в
    // initializeAllFamilyTrees(), которая находит все контейнеры
    // .f3[data-root-id] на странице.
})();